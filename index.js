...
console.log("isPrimeNumber(0)", isPrimeNumber(0)); // Виведе: false
...
console.log("Значення (42) має тип даних:", checkDataType(42)); // Виведе: Значення "42" має тип "number".
console.log("Значення ('Hello') має тип даних:", checkDataType("Hello")); // Виведе: Значення "Hello" має тип "string".
console.log("Значення (true) має тип даних:", checkDataType(true)); // Виведе: Значення "true" має тип "boolean".
console.log("Значення (undefined) має тип даних:", checkDataType(undefined)); // Виведе: Значення "undefined" має тип "undefined".
...
function getUserStatus(age) {
  ...
  if (age < 18) {
    return (age = "Неповнолітній");
  } else if (age >= 18 && age < 65) {
    return (age = "Дорослий");
  } else {
    return (age = "Пенсіонер");
  }
...
function getDayOfWeek(dayNumber) {
  ...
  switch (dayNumber) {
    case 1:
      return (dayNumber = "Понеділок");
    case 2:
      return (dayNumber = "Вівторок");
    case 3:
      return (dayNumber = "Середа");
    case 4:
      return (dayNumber = "Четвер");
    case 5:
      return (dayNumber = "П'ятниця");
    case 6:
      return (dayNumber = "Субота");
    case 7:
      return (dayNumber = "Неділя");
    default:
      return (dayNumber = "Невірний номер дня");
  }
...
function getVariableType(variable) {
  ...
  if (typeof variable === "number") {
    return (variable = "Це число");
  } else if (typeof variable === "string") {
    return (variable = "Це рядок");
  } else if (typeof variable === "boolean") {
    return (variable = "Це булеве значення");
  } else if (typeof variable === "object") {
    return (variable = "Це інший тип");
  }
...
function memoizedArea(prevSide = null, prevResult = null) {
  //   const result = `${side ** 2}`;
  return (side) => {
    if (prevSide == side) {
